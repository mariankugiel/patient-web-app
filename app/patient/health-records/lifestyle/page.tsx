...
export default function LifestylePage() {
  ...
  const { sections, adminTemplates, loading, createSection, updateSection, createMetric, updateMetric, createRecord, refresh } = useAnalysisDashboard(3) // Lifestyle type ID
