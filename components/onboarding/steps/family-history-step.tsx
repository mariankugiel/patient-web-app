...
export function FamilyHistoryStep({ language }: FamilyHistoryStepProps) {
  ...
  // Grandparent forms (maternal and paternal) - shown as default
  const [maternalGrandmotherForm, setMaternalGrandmotherForm] = useState<FamilyMemberForm>({
    isDeceased: false,
    ageAtDeath: "",
    causeOfDeath: "",
    chronicDiseases: []
  ...
  const [maternalGrandfatherForm, setMaternalGrandfatherForm] = useState<FamilyMemberForm>({
    isDeceased: false,
    ageAtDeath: "",
    causeOfDeath: "",
    chronicDiseases: []
  ...
  const [paternalGrandmotherForm, setPaternalGrandmotherForm] = useState<FamilyMemberForm>({
    isDeceased: false,
    ageAtDeath: "",
    causeOfDeath: "",
    chronicDiseases: []
  ...
  const [paternalGrandfatherForm, setPaternalGrandfatherForm] = useState<FamilyMemberForm>({
    isDeceased: false,
    ageAtDeath: "",
    causeOfDeath: "",
    chronicDiseases: []
  ...
  const removeChronicDisease = (formType: 'mother' | 'father' | 'maternalGrandmother' | 'maternalGrandfather' | 'paternalGrandmother' | 'paternalGrandfather' | 'sibling' | 'child', diseaseId: string, index?: number) => {
    if (formType === 'mother') {
      setMotherForm(prev => ({
        ...prev,
  ...
  const updateChronicDisease = (formType: 'mother' | 'father' | 'maternalGrandmother' | 'maternalGrandfather' | 'paternalGrandmother' | 'paternalGrandfather' | 'sibling' | 'child', diseaseId: string, field: keyof ChronicDisease, value: string, index?: number) => {
    if (formType === 'mother') {
      setMotherForm(prev => ({
        ...prev,
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Maternal Grandmother Form (Default) */}
      <FamilyMemberForm
        title="Maternal Grandmother"
        formData={maternalGrandmotherForm}
        setFormData={setMaternalGrandmotherForm}
        formType="maternalGrandmother"
      />

      {/* Maternal Grandfather Form (Default) */}
      <FamilyMemberForm
        title="Maternal Grandfather"
        formData={maternalGrandfatherForm}
        setFormData={setMaternalGrandfatherForm}
        formType="maternalGrandfather"
      />

      {/* Paternal Grandmother Form (Default) */}
      <FamilyMemberForm
        title="Paternal Grandmother"
        formData={paternalGrandmotherForm}
        setFormData={setPaternalGrandmotherForm}
        formType="paternalGrandmother"
      />

      {/* Paternal Grandfather Form (Default) */}
      <FamilyMemberForm
        title="Paternal Grandfather"
        formData={paternalGrandfatherForm}
        setFormData={setPaternalGrandfatherForm}
        formType="paternalGrandfather"
      />
